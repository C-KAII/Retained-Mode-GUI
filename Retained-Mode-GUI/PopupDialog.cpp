...
//}
//
//void PopupDialog::addTextBox(const std::string& message) {
//
//}
//
...
//  m_textFields.push_back(std::make_unique<TextField>(GEN_ID, m_x + 10, textFieldY, m_width - 20, 0, label));
...
//    GEN_ID, buttonX, buttonY, 100, 30,
//    onClick, label, LabelPosition::INSIDE, UTILS::COLOR::LIGHT_GREY
//  ));
//}
//
